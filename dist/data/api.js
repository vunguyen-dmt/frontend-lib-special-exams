...
function _fetchExamAttemptsData() {
  _fetchExamAttemptsData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(courseId, sequenceId) {
...
function fetchLatestAttempt(_x3) {
  return _fetchLatestAttempt.apply(this, arguments);
}
function _fetchLatestAttempt() {
  _fetchLatestAttempt = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(courseId) {
...
function pollExamAttempt(_x4) {
  return _pollExamAttempt.apply(this, arguments);
}
function _pollExamAttempt() {
  _pollExamAttempt = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(url) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          edxProctoringURL = new URL("".concat((0, _frontendPlatform.getConfig)().LMS_BASE_URL).concat(url));
          _context4.next = 4;
...
function createExamAttempt(_x5, _x6) {
  return _createExamAttempt.apply(this, arguments);
}
function _createExamAttempt() {
  _createExamAttempt = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(examId, legacyAttempt) {
    var startClock,
      attemptProctored,
      urlString,
      url,
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          startClock = _args5.length > 2 && _args5[2] !== undefined ? _args5[2] : true;
          attemptProctored = _args5.length > 3 && _args5[3] !== undefined ? _args5[3] : false;
        ...
        case 7:
          _yield$getAuthenticat = _context5.sent;
...
function updateAttemptStatus(_x7, _x8, _x9) {
  return _updateAttemptStatus.apply(this, arguments);
}
function _updateAttemptStatus() {
  _updateAttemptStatus = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(attemptId, action, legacyAttempt) {
    var detail,
      urlString,
      url,
      payload,
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          detail = _args6.length > 3 && _args6[3] !== undefined ? _args6[3] : null;
          if (!(0, _frontendPlatform.getConfig)().EXAMS_BASE_URL || legacyAttempt) {
        ...
        case 7:
          _yield$getAuthenticat2 = _context6.sent;
...
function stopAttempt(_x10) {
  return _stopAttempt.apply(this, arguments);
}
function _stopAttempt() {
  _stopAttempt = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(attemptId) {
    var legacyAttempt,
      _args7 = arguments;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          legacyAttempt = _args7.length > 1 && _args7[1] !== undefined ? _args7[1] : false;
          return _context7.abrupt("return", updateAttemptStatus(attemptId, _constants.ExamAction.STOP, legacyAttempt));
        case 2:
        case "end":
...
function continueAttempt(_x11) {
  return _continueAttempt.apply(this, arguments);
}
function _continueAttempt() {
  _continueAttempt = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(attemptId) {
    var legacyAttempt,
      _args8 = arguments;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          ...
          return _context8.abrupt("return", updateAttemptStatus(attemptId, _constants.ExamAction.START, legacyAttempt));
        case 2:
        case "end":
...
function submitAttempt(_x12) {
  return _submitAttempt.apply(this, arguments);
}
function _submitAttempt() {
  _submitAttempt = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(attemptId) {
    var legacyAttempt,
      _args9 = arguments;
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        case 0:
          ...
          return _context9.abrupt("return", updateAttemptStatus(attemptId, _constants.ExamAction.SUBMIT, legacyAttempt));
        case 2:
        case "end":
...
function resetAttempt(_x13) {
  return _resetAttempt.apply(this, arguments);
}
function _resetAttempt() {
  _resetAttempt = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(attemptId) {
    var legacyAttempt,
      _args10 = arguments;
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        case 0:
          ...
          return _context10.abrupt("return", updateAttemptStatus(attemptId, _constants.ExamAction.RESET, legacyAttempt));
        case 2:
        case "end":
...
function endExamWithFailure(_x14, _x15) {
  return _endExamWithFailure.apply(this, arguments);
}
function _endExamWithFailure() {
  _endExamWithFailure = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11(attemptId, error) {
    var legacyAttempt,
      _args11 = arguments;
    return _regeneratorRuntime().wrap(function _callee11$(_context11) {
      while (1) switch (_context11.prev = _context11.next) {
        case 0:
          legacyAttempt = _args11.length > 2 && _args11[2] !== undefined ? _args11[2] : false;
          return _context11.abrupt("return", updateAttemptStatus(attemptId, _constants.ExamAction.ERROR, legacyAttempt, error));
        case 2:
        case "end":
...
function softwareDownloadAttempt(_x16) {
  return _softwareDownloadAttempt.apply(this, arguments);
}
function _softwareDownloadAttempt() {
  _softwareDownloadAttempt = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12(attemptId) {
    var legacyAttempt,
      _args12 = arguments;
    return _regeneratorRuntime().wrap(function _callee12$(_context12) {
      while (1) switch (_context12.prev = _context12.next) {
        case 0:
          legacyAttempt = _args12.length > 1 && _args12[1] !== undefined ? _args12[1] : false;
          return _context12.abrupt("return", updateAttemptStatus(attemptId, _constants.ExamAction.CLICK_DOWNLOAD_SOFTWARE, legacyAttempt));
        case 2:
        case "end":
...
function declineAttempt(_x17) {
  return _declineAttempt.apply(this, arguments);
}
function _declineAttempt() {
  _declineAttempt = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13(attemptId) {
    var legacyAttempt,
      _args13 = arguments;
    return _regeneratorRuntime().wrap(function _callee13$(_context13) {
      while (1) switch (_context13.prev = _context13.next) {
        case 0:
          ...
          return _context13.abrupt("return", updateAttemptStatus(attemptId, _constants.ExamAction.DECLINE, legacyAttempt));
        case 2:
        case "end":
...
function fetchExamReviewPolicy(_x18) {
  return _fetchExamReviewPolicy.apply(this, arguments);
}
function _fetchExamReviewPolicy() {
  _fetchExamReviewPolicy = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(examId) {
    ...
    return _regeneratorRuntime().wrap(function _callee14$(_context14) {
      while (1) switch (_context14.prev = _context14.next) {
        case 0:
          ...
          return (0, _auth.getAuthenticatedHttpClient)().get(url.href);
        case 3:
          _yield$getAuthenticat3 = _context14.sent;
...
function fetchProctoringSettings(_x19, _x20) {
  return _fetchProctoringSettings.apply(this, arguments);
}
function _fetchProctoringSettings() {
  _fetchProctoringSettings = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee15(courseId, examId) {
    ...
    return _regeneratorRuntime().wrap(function _callee15$(_context15) {
      while (1) switch (_context15.prev = _context15.next) {
        case 0:
          ...
          return (0, _auth.getAuthenticatedHttpClient)().get(url.href);
        case 3:
          _yield$getAuthenticat4 = _context15.sent;
...
function fetchExamAccessToken(_x21) {
  return _fetchExamAccessToken.apply(this, arguments);
}
function _fetchExamAccessToken() {
  _fetchExamAccessToken = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee16(examId) {
    ...
    return _regeneratorRuntime().wrap(function _callee16$(_context16) {
      while (1) switch (_context16.prev = _context16.next) {
        case 0:
          ...
          return (0, _auth.getAuthenticatedHttpClient)().get(url.href);
        case 3:
          _yield$getAuthenticat5 = _context16.sent;
